...
print "unimedida: ". is_dir("unimedida");
                    ...
                    if ($total < 1) {
                        ...
                        foreach ($xml as $produto) {
                            ...
                            /*try {
                                ...
                                $db = new PDO("mysql:host=$ip;dbname=metaf215_loristore;charset=utf-8", $login, $senha);

                                $result = $db->exec($inserir_product);
                            ...
                            if (mysql_query($inserir_product, $conecta)) {
                                ...
                                print "<h4>Ultimo</h4>". $ultimo_id_produtc;
...
print "relcategorias: ". is_dir("relcategorias");
