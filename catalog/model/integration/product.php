<?php
class ModelIntegrationProduct extends Model {
	public function addProduct($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET 
			...
			icodintprosis = '" . (int)$data['icodintprosis'] . "', 
			ccodprosis = '" . $data['ccodprosis'] . "', 
			prodrel = '" . $data['prodrel'] . "', 			
		...
		if(isset($data['produtos_relacionados'])) {

			foreach ($data['produtos_relacionados'] as $product_option) {
				...
				foreach ($product_option['product_option_value'] as $product_option_value) {
					...
					$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET 
						...
						icodintprosis = '" . (int)$product_option_value['icodintprosis'] . "', 
						ccodprosis = '" . $this->db->escape($product_option_value['ccodprosis']) . "', 
						");
						...
						if(isset($product_option['product_option_value'])) {
							...
							foreach ($product_option['product_option_value'] as $product_option_value) {
								...
								$this->db->query("DELETE FROM " . DB_PREFIX . "product_option_value WHERE 
									product_id = '" . (int)$product_id . "' AND 
									option_id = '" . (int)$product_option['option_id'] . "' AND 
									option_value_id = '" . (int)$product_option_value['option_value_id'] . "' AND 
									product_option_id = '" . (int)$product_option['product_option_id'] . "'");
		...
		if (isset($data['product_image'])) {
			foreach ($data['product_image'] as $product_image) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_image SET 
					...
					cimagem = '" . $this->db->escape($product_image['cimagem']) . "',
	...
	public function getProduct($product_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) WHERE p.icodintprosis = '" . (int)$product_id . "' AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
