<div class="list-group">
  ...
  <a target="_blank" href="http://www2.correios.com.br/sistemas/rastreamento/default.cfm" class="list-group-item">Rastreie seu pedido</a>
  <?php if(false) { ?><a href="<?php echo $download; ?>" class="list-group-item"><?php echo $text_download; ?></a>
  ...
  <a href="<?php echo $newsletter; ?>" class="list-group-item"><?php echo $text_newsletter; ?></a><?php } ?>
  <?php if ($logged) { ?>
