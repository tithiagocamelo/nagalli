...
<div class="row">
	<form action="" method="post" class="form-horizontal jumbotron" id="newsletter-email">
		...
		<div class="input-group" id="form-newsletter-error">
			...
			<div class="input-group-btn">
				<button type="submit" class="btn btn-default" onclick="return regNewsletter();"><i class="fa fa-envelope"></i></button>
			</div>
		</div>
