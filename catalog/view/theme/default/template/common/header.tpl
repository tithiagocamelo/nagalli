...
<?php } ?>
<script src="catalog/view/javascript/common.min.js?v=0.4" type="text/javascript"></script>
    ...
    <div class="col-sm-4 pull-right jumbotron-ls">
      <div id="top-links" class="nav pull-right">
        <ul class="list-inline">
          ...
          <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><img src="image/catalog/icon/002-avatar.png" height="24" width="24"></img> 
          <!--<span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span>--></a>
            <ul class="dropdown-menu dropdown-menu-right">
              ...
              <li><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li><?php } ?>
          ...
          <li><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><img src="image/catalog/icon/001-business.png" height="24" width="24"><!--<i class="fa fa-ls fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_shopping_cart; ?></span>--></a></li>
