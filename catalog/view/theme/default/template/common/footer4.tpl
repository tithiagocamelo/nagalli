  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-2">
        ...
        <p>Para fazer de sua compra uma experiência segura, a Lori Store trabalha exclusivamente com o Pagseguro, que oferece a opção de pagamento por boleto ou cartão de credito (ate 12 x sem juros aceitando mais de 20 bandeiras). </p>
      </div>
      <div class="col-sm-2">
        <h5><?php echo $text_account; ?></h5>
        <ul class="list-unstyled">
