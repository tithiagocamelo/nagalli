<?php
class ModelToolConver extends Model {
	...
	public function addOrder($data) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET 
			...
			cod_correios = '" . $this->db->escape($data['cod_correios']) . "', 
