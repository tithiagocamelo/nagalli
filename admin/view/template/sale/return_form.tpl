          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <fieldset>
              ...
              <table class="table table-bordered table-hover">
                <thead>
                  <tr>
                    <td class="text-left" style="width: 150px;"><?php echo $entry_order_id; ?></td>
                    <td class="text-left" style="width: 150px;"><?php echo $entry_model; ?></td>
                    <td class="text-left"><?php echo $entry_product; ?></td>
                    <td class="text-left" style="width: 150px;"><?php echo $entry_quantity; ?></td>
                  </tr>
                </thead>
                <tbody>
                  <!-- foreach -->
                  <?php foreach ($produtos as $produto) { ?>
                    <tr>
                      <td class="text-left"><?php echo $produto['order_id']; ?></td>
                      <input type="hidden" name="product_id" value="<?php echo $$produto['product_id']; ?>" />
                      <td class="text-left"><?php echo $produto['model']; ?></td>
                      <td class="text-left"><?php echo $produto['product']; ?></td>
                      <td class="text-left"><?php echo $produto['quantity']; ?></td>
                    </tr>
                  <!-- endforeach -->
                  <?php } ?>
                </tbody>
