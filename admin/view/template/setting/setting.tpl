          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-valor-minimo-primeira"><span data-toggle="tooltip" title="<?php echo $help_valor_minimo_primeira; ?>"><?php echo $entry_valor_minimo_primeira; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_valor_minimo_primeira" value="<?php echo $config_valor_minimo_primeira; ?>" placeholder="<?php echo $entry_valor_minimo_primeira; ?>" id="input-valor-minimo-primeira" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-valor-minimo-demais"><span data-toggle="tooltip" title="<?php echo $help_valor_minimo_demais; ?>"><?php echo $entry_valor_minimo_demais; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_valor_minimo_demais" value="<?php echo $config_valor_minimo_demais; ?>" placeholder="<?php echo $entry_valor_minimo_demais; ?>" id="input-valor-minimo-demais" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
