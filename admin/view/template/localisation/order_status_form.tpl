      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-order-status" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="mensagem_id" id="input-mensagem" class="form-control">
                <option value="0"> -- Selecione -- </option>
                <?php foreach ($mensagens as $mensagem) { ?>
                  <?php  if ($mensagem['mensagem_id'] == $mensagem_id) { ?>
                    <option value="<?php echo $mensagem['mensagem_id']; ?>" selected="selected"><?php echo $mensagem['titulo']; ?></option>
                  <?php } else { ?>
