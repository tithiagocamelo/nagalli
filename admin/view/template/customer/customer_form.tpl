                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-oldclient"><span data-toggle="tooltip" title="<?php echo $help_old_client; ?>"><?php echo $entry_old_client; ?></label>
                        <div class="col-sm-10">
                          <select name="old_client" id="input-oldclient" class="form-control">
                            <?php if ($old_client) { ?>
                            <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                            <option value="0"><?php echo $text_no; ?></option>
                            <?php } else { ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#input-custom-field2').mask('000.000.000-00')
    $('#input-custom-field1').mask('00.000.000/0000-00')
    
    $('#input-telephone').mask('(00) 0000-00000')
    $("[id=input-postcode_]").mask('00000-000')
  })
</script>
</div>
<?php echo $footer; ?>
