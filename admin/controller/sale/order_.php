...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['shipping_method'] = $order_info['shipping_method'];
			$data['payment_method'] = $order_info['payment_method'];
			$data['cod_correios'] = $order_info['cod_correios'];
			...
			$data['mensagens'] = $this->model_localisation_mensagem->getMensagens();
			$data['message_link'] = $this->url->link('localisation/mensagem/get', 'token=' . $this->session->data['token'], true);
