...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'num_pedido'	=> $result['icodpedvenda'] ? $result['icodpedvenda'] : 'Não Importado',
	...
	public function info() {
		...
		if ($order_info) {
			...
			$cpf_cnpj = (isset($order_info['custom_field'][1]) and strlen($order_info['custom_field'][1]) > 0 ) ? $order_info['custom_field'][1] .' - I.E.: '. $order_info['custom_field'][3] : $order_info['custom_field'][2];
			...
			$replace = array(
				...
				'numero'    => $order_info['payment_custom_field'][5],
			...
			$replace = array(
				...
				'numero' 	=> $order_info['shipping_custom_field'][5],
