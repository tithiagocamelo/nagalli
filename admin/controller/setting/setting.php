...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_valor_minimo_primeira'] = $this->language->get('entry_valor_minimo_primeira');
		$data['entry_valor_minimo_demais'] = $this->language->get('entry_valor_minimo_demais');
		...
		$data['help_valor_minimo_primeira'] = $this->language->get('help_valor_minimo_primeira');
		$data['help_valor_minimo_demais'] = $this->language->get('help_valor_minimo_demais');
		...
		if (isset($this->request->post['config_valor_minimo_primeira'])) {
			$data['config_valor_minimo_primeira'] = $this->request->post['config_valor_minimo_primeira'];
		} else {
			$data['config_valor_minimo_primeira'] = $this->config->get('config_valor_minimo_primeira');
		}

		if (isset($this->request->post['config_valor_minimo_demais'])) {
			$data['config_valor_minimo_demais'] = $this->request->post['config_valor_minimo_demais'];
		} else {
			$data['config_valor_minimo_demais'] = $this->config->get('config_valor_minimo_demais');
		}
