...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_old_client'] = $this->language->get('entry_old_client');
		...
		$data['help_old_client'] = $this->language->get('help_old_client');
		...
		if (isset($this->request->post['old_client'])) {
			$data['old_client'] = $this->request->post['old_client'];
		} elseif (!empty($customer_info)) {
			$data['old_client'] = $customer_info['old_client'];
		} else {
			$data['old_client'] = 0;
		}
